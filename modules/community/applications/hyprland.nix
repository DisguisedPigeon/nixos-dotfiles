{ inputs, ... }:
{
  ...
  flake.modules.homeManager.hyprland = {
    imports = [
      inputs.self.flake.modules.homeManager.dunst
      inputs.self.flake.modules.homeManager.hyprlock
      inputs.self.flake.modules.homeManager.waybar
      inputs.self.flake.modules.homeManager.rofi
    ];
