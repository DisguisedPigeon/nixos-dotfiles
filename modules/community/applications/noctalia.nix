  ...
  flake.modules.homeManager.noctalia =
    { pkgs, ... }:
    {
      ...
      programs.noctalia-shell = {
        enable = false;
        systemd.enable = true;
        # Autogenerated by the systemd service.
        # Alternatively, pass the NOCTALIA_SETTINGS_FALLBACK env var, pointing to the destination json file. From there, you are a few regexes away from the end result
        settings = {
          appLauncher = {
