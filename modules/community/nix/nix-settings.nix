...
"
        ...
        system-only-nix-conf-content = ''
          ...
          substituters = https://nixos-raspberrypi.cachix.org?priority=6 https://niri.cachix.org?priority=3 https://raspberry-pi-nix.cachix.org?priority=5 https://nix-community.cachix.org?priority=2 https://cache.nixos.org?priority=1 https://devenv.cachix.org?priority=4
