...
---Adds a normal mode mapping.
---@param suffix string the keys following <Leader>.
...
-- MiniHarp.nvim
vim.keymap.set("n", "<C-n>", "<Cmd>lua require'miniharp'.next()<CR>", { desc = "MiniHarp: next" })
vim.keymap.set("n", "<C-p>", "<Cmd>lua require'miniharp'.prev()<CR>", { desc = "MiniHarp: prev" })
vim.keymap.set("n", "<leader>hv", "<Cmd>lua require'miniharp'.show_list()<CR>", { desc = "list" })
vim.keymap.set("n", "<leader>ht", "<Cmd>lua require'miniharp'.toggle_file()<CR>", { desc = "toggle" })
...
nmap_leader("ec", "<Cmd>edit $MYVIMRC<CR>", "Configuration")
